...
<!--Header-part-->
<div id="header">
  <h1><a href="entri_referensi.php">Menu Makanan</a></h1>
</div>
<!--close-Header-part--> 
...
<!--close-top-serch-->
<!--sidebar-menu-->
<div id="sidebar"><a href="entri_referensi.php" class="visible-phone"><i class="icon icon-tasks"></i> <span>Menu Makanan</span></a>
  <ul>
    <?php
    if($r['id_level'] == 1){
  ?>
    <li><a href="beranda.php"><i class="icon icon-home"></i> <span>Beranda</span></a> </li>
    <li class="active"> <a href="entri_referensi.php"><i class="icon icon-tasks"></i> <span>Menu Makanan</span></a> </li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="entri_referensi.php" title="Go to here" class="tip-bottom"><i class="icon icon-tasks"></i> Menu Makanan</a></div>
  </div>
<!--End-breadcrumbs-->
